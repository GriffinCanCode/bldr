/* Stub for x86 SSE2 on ARM */
#include "blake3_simd.h"
void blake3_compress_sse2(const uint32_t cv[8], const uint8_t block[64], uint8_t block_len, uint64_t counter, uint8_t flags, uint8_t out[64]) {
