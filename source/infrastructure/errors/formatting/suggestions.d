...
struct SuggestionGenerator
{
    ...
    private static const(ErrorSuggestion)[] generateFromCode(ErrorCode code) @trusted
    {
        ...
        switch (code)
        {
            ...
            case Parse.InvalidConfiguration:
            ...
            case Analysis.ImportResolutionFailed:
            ...
            case Analysis.CircularDependency:
            ...
            case Analysis.MissingDependency:
            ...
            case System.ProcessSpawnFailed:
            ...
            case Language.CompilationFailed:
            ...
            case Config.SchemaValidationFailed:
            ...
            case Repository.VerificationFailed:
