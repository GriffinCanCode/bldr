...
struct SuggestionGenerator
{
    ...
    private static const(ErrorSuggestion)[] generateFromCode(ErrorCode code) @trusted
    {
        ...
        {
            // IO Errors (5000-5999)
            case cast(ErrorCode) IO.FileNotFound:
            ...
            case cast(ErrorCode) IO.FileReadFailed:
            ...
            case cast(ErrorCode) IO.FileWriteFailed:
            ...
            case cast(ErrorCode) IO.DirectoryNotFound:
            ...
            case cast(ErrorCode) IO.PermissionDenied:
            ...
            case cast(ErrorCode) Parse.Failed:
            ...
            case cast(ErrorCode) Parse.InvalidJson:
            ...
            case cast(ErrorCode) Parse.InvalidBuildFile:
            ...
            case cast(ErrorCode) Parse.MissingField:
            ...
            case cast(ErrorCode) Parse.InvalidFieldValue:
            ...
            case cast(ErrorCode) Parse.InvalidGlob:
            ...
            case cast(ErrorCode) Parse.InvalidConfiguration:
            ...
            case cast(ErrorCode) Analysis.Failed:
            ...
            case cast(ErrorCode) Analysis.ImportResolutionFailed:
            ...
            case cast(ErrorCode) Analysis.CircularDependency:
            ...
            case cast(ErrorCode) Analysis.MissingDependency:
            ...
            case cast(ErrorCode) Analysis.InvalidImport:
            ...
            case cast(ErrorCode) Build.Failed:
            ...
            case cast(ErrorCode) Build.Timeout:
            ...
            case cast(ErrorCode) Build.TargetNotFound:
            ...
            case cast(ErrorCode) Build.HandlerNotFound:
            ...
            case cast(ErrorCode) Build.OutputMissing:
            ...
            case cast(ErrorCode) Cache.LoadFailed:
            ...
            case cast(ErrorCode) Cache.SaveFailed:
            ...
            case cast(ErrorCode) Cache.Corrupted:
            ...
            case cast(ErrorCode) Cache.NotFound:
            ...
            case cast(ErrorCode) Cache.TooLarge:
            ...
            case cast(ErrorCode) Network.Error:
            ...
            case cast(ErrorCode) System.ProcessSpawnFailed:
            ...
            case cast(ErrorCode) System.ProcessTimeout:
            ...
            case cast(ErrorCode) System.ProcessCrashed:
            ...
            case cast(ErrorCode) System.OutOfMemory:
            ...
            case cast(ErrorCode) Language.CompilationFailed:
            ...
            case cast(ErrorCode) Language.UnsupportedLanguage:
                suggestions ~= ErrorSuggestion.command("List supported languages", "bldr query --languages");
            ...
            case cast(ErrorCode) Language.MissingCompiler:
            ...
            case cast(ErrorCode) Plugin.NotFound:
            ...
            case cast(ErrorCode) Plugin.LoadFailed:
            ...
            case cast(ErrorCode) Plugin.VersionMismatch:
            ...
            case cast(ErrorCode) LSP.InitializationFailed:
            ...
            case cast(ErrorCode) LSP.DocumentNotFound:
            ...
            case cast(ErrorCode) Watch.InitFailed:
            ...
            case cast(ErrorCode) Watch.TooManyTargets:
            ...
            case cast(ErrorCode) Config.InvalidWorkspace:
            ...
            case cast(ErrorCode) Config.InvalidTarget:
            ...
            case cast(ErrorCode) Config.SchemaValidationFailed:
            ...
            case cast(ErrorCode) Config.DuplicateTarget:
            ...
            case cast(ErrorCode) Migration.Failed:
            ...
            case cast(ErrorCode) Repository.NotFound:
            ...
            case cast(ErrorCode) Repository.FetchFailed:
                suggestions ~= ErrorSuggestion("Check network connectivity");
            ...
            case cast(ErrorCode) Repository.VerificationFailed:
            ...
            case cast(ErrorCode) Internal.Error:
            ...
            case cast(ErrorCode) Internal.NotImplemented:
